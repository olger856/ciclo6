...
class InicioAsistenciaAlumnoDetalle extends StatefulWidget {

  const InicioAsistenciaAlumnoDetalle({Key? key}) : super(key: key);
  @override
  State<InicioAsistenciaAlumnoDetalle> createState() => _InicioAsistenciaAlumnoDetalleState();
}

class _InicioAsistenciaAlumnoDetalleState extends State<InicioAsistenciaAlumnoDetalle> {
